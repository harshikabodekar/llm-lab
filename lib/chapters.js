...
export const CHAPTERS = [
  ...
  {
    id: "boss1", part: 1, num: "boss", isBoss: true, title: "Part 1 Boss: Fix the Pipeline",
    hook: "You've built a tokenizer. You've built cosine similarity. Now debug someone else's broken versions — 2 bugs, hidden in code that LOOKS right.",
    status: "live", playground: "debug the broken tokenizer + similarity pipeline",
    recap: "reading code critically — spotting what SHOULD happen vs what a bug makes actually happen — is half of real engineering."
  },
  // ---------- PART 2 ----------
  {
  ...
  },
  {
    ...
    status: "live", playground: "live char-GPT training",
  ...
  },
  {
    ...
    status: "live", playground: "base vs chat side-by-side",
  ...
  },
  {
    ...
    status: "live", playground: "you-are-the-reward-model game",
    recap: "humans rank outputs → reward model learns taste → model optimizes for it."
  },
  {
    id: "boss2", part: 2, num: "boss", isBoss: true, title: "Part 2 Boss: Diagnose the Training Run",
    hook: "Two training runs, two planted bugs — a flipped gradient sign and a learning rate way too high. Diagnose each from the loss curve, then fix it for real.",
    status: "live", playground: "read the curve, fix the code",
    recap: "a loss curve's SHAPE is diagnostic information — climbing steadily means a sign error, wild growing oscillation means the learning rate is too high."
  },
  // ---------- PART 3 ----------
  {
    ...
    status: "live", playground: "probability bars + temperature slider",
  ...
  },
  {
    ...
    status: "live", playground: "prompt comparison lab (gemini free tier)",
  ...
  },
  {
    ...
    status: "live", playground: "context overflow visualizer",
  ...
  },
  {
    ...
    status: "live", playground: "full RAG pipeline builder — you write chunking + cosine similarity",
  ...
  },
  {
    ...
    status: "live", playground: "brute force vs index race",
  ...
  },
  {
    ...
    status: "live", playground: "build the agent loop",
  ...
  },
  {
    ...
    status: "live", playground: "adapter visualizer",
    recap: "LoRA = freeze the model, train small add-on matrices. finetune behavior, not knowledge. RAG for facts."
  },
  {
    id: "boss3", part: 3, num: "boss", isBoss: true, title: "Part 3 Boss: Fix the RAG Pipeline",
    hook: "A RAG pipeline is returning garbage answers. A hardcoded chunk size and a backwards similarity sort are hiding in plain sight — find both, fix both.",
    status: "live", playground: "debug the broken RAG pipeline",
    recap: "silent bugs — wrong output, no crash — are the most dangerous kind. they ship, and nobody notices until it's too late."
  },
  // ---------- PART 4 ----------
  {
    ...
    status: "live", playground: "hallucination hunt",
  ...
  },
  {
    ...
    status: "live", playground: "build a mini eval suite",
  ...
  },
  {
    ...
    status: "live", playground: "scale slider: params, data, cost",
  ...
  },
  {
    ...
    status: "live", playground: "guided capstone builder",
  ...
  },
  {
    ...
    status: "live", playground: "roadmap with live checkboxes + your-code-vs-pytorch side-by-sides",
    recap: "weeks 1-2 pytorch basics · 3-4 rebuild our tiny GPT · 5-8 nanoGPT on a rented GPU · 9-12 LoRA-finetune an open model."
  },
  {
    id: "boss4", part: 4, num: "boss", isBoss: true, title: "Part 4 Boss: Is This AI Ready to Ship?",
    hook: "A fictional 'ready to ship' report, full of confident numbers. 3 of them are real red flags. Find all 3 — everything else genuinely checks out.",
    status: "live", playground: "audit the ship-readiness report",
    recap: "confident numbers aren't the same as trustworthy numbers — check the sample, check for contamination, check what wasn't tested at all."
  }
];
