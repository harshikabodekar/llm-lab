export const CH0_CONTENT = {
  ...
  intro: {
    what: "run 4 tiny python cells — variables, lists, functions, loops.",
    why: "every playground after this one assumes you know these 4 things. 20 minutes now saves confusion later.",
    how: "work top to bottom, run each cell, read the output before moving on."
  },
  challenge:
