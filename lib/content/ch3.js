export const CH3_CONTENT = {
  ...
  intro: {
    what: "drag word-points around a 2D map and run the king − man + woman demo.",
    why: "this is literally how models represent meaning — as position, not as text.",
    how: "drag a point, then press the arithmetic button and read the closest match."
  },
  challenge:
